  ...
  return(
    <main className="border-2 border-orange min-h-svh bg-offwhitebg py-20 px-6">
      <section>
       ...
       <a className="font-lexend bg-offwhitebg block px-10 py-3 w-fit rounded-3xl text-dark-green"  href="https://www.webmotors.com.br/wm1/dinheiro-e-economia/dez-carros-de-luxo-usados-por-ate-r-100-mil" target="_blank">Ver mais</a>
       </div>
      </section>
    </main>
  )
